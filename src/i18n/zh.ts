export const chinese: Record<string, string> = {
  ...
  'Type de rendu': '渲染类型',
  'Chaque style change la finition, pas la forme.': '每种样式只改变表面效果，不改变形状。',
  Vectoriel: '矢量',
  Contour: '描边',
  Borderlands: '墨线',
  Encre: '墨色',
  ...
  Lueur: '光晕',
  Pixel: '像素',
  'Épaisseur du contour': '描边宽度',
  'Épaisseur de l’encre': '墨线粗细',
  Irrégularité: '抖动',
  'Couleurs et motifs': '颜色与花纹',
  ...
  Aucune: '无',
  Aucun: '无',
  'Harmonies suggérées': '推荐配色',
  Complémentaire: '互补色',
  Analogue: '邻近色',
  Triadique: '三角配色',
  'Complémentaire divisée': '分裂互补色',
  'Ton sur ton': '同色系',
  Pastel: '粉彩',
  Braise: '余烬',
  'Palette surprise': '随机调色板',
  'Ombrage cartoon': '卡通阴影',
  'Une ombre franche et un reflet qui suivent la silhouette, par-dessus n’importe quel rendu.':
    '沿轮廓生成清晰的阴影和高光，可叠加在任何渲染样式上。',
  Ombre: '阴影',
  Reflet: '高光',
  'Épaisseur de l’ombre': '阴影宽度',
  'Direction de la lumière': '光照方向',
  'Couleur de l’ombre': '阴影颜色',
  Motifs: '花纹',
  'Taches, rayures, gemmes et zones bicolores qui épousent la forme principale en 3D.':
    '斑点、条纹、宝石和双色区域，会以 3D 方式贴合主形状。',
  'Ajouter un motif': '添加花纹',
  'Tache du ventre': '肚皮斑',
  Museau: '口鼻',
  Masque: '面罩',
  Joues: '腮红',
  ...
  Taches: '斑点',
  Rayures: '条纹',
  'Dessus bicolore': '上半双色',
  'Dessous bicolore': '下半双色',
  Ovale: '椭圆',
  Losange: '菱形',
  'Carré doux': '圆角方形',
  Croissant: '新月',
  ...
  Symétrie: '对称',
  'Nouveau tirage': '重新随机',
  'Couleur de la partie': '部件颜色',
  Pointe: '尖端',
  'Longueur de la pointe': '尖端长度',
  Anneaux: '环纹',
  'Nombre d’anneaux': '环纹数量',
  'Couleur de la forme': '形状颜色',
  'Intensité de l’ombre': '阴影强度',
  'Taille de la lueur': '光晕大小',
  'Définition de la grille': '网格分辨率',
  'Apparence et orientation générale de l’avatar.': '头像的整体外观和方向。',
  'Couleur du corps': '身体颜色',
  'Fond de la scène': '舞台背景',
  Scène: '舞台',
  'Couleur derrière l’avatar sur la scène.': '舞台上角色背后的颜色。',
  ...
  'La clé reste dans cette session et n’est pas enregistrée.': '密钥只留在本次会话中，不会被保存。',
  'Clé Azure': 'Azure 密钥',
  'Région Azure': 'Azure 区域',
  Phrase: '句子',
  Langue: '语言',
  Anglais: '英语',
  Espagnol: '西班牙语',
  ...
  Excité: '兴奋',
  Chuchoté: '耳语',
  'Colle ta clé Azure Speech.': '粘贴你的 Azure Speech 密钥。',
  'Indique la région, par exemple eastus.': '填写区域，例如 eastus。',
  'Écris ce que l’avatar doit dire.': '写下头像要说的话。',
  'Génération…': '生成中…',
  Prêt: '就绪',
  'En train de parler': '正在说话',
  'La synthèse a échoué.': '语音生成失败。',
  Expressions: '表情',
  Animations: '动画',
  Exporter: '导出',
  Export: '导出',
...
export const translateChineseDynamicText = (text: string) => {
  const rules: Array<[RegExp, (...matches: string[]) => string]> = [
    ...
    [/^Ajouter une partie · (.+)$/, value => `添加部件 · ${value}`],

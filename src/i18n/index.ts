...
const english: Record<string, string> = {
  ...
  'Chaque style change la finition, pas la forme.': 'Each style changes the finish, not the shape.',
  Vectoriel: 'Vector',
  Contour: 'Outline',
  Borderlands: 'Borderlands',
  Encre: 'Ink',
  'Ombre douce': 'Soft shade',
  Lueur: 'Glow',
  Pixel: 'Pixel',
  'Épaisseur du contour': 'Outline width',
  'Épaisseur de l’encre': 'Ink thickness',
  Irrégularité: 'Wobble',
  'Couleurs et motifs': 'Colors & markings',
  'Palette, couleurs des parties, motifs 3D et ombrage cartoon.':
    'Palette, part colors, 3D markings and cartoon shading.',
  Palette: 'Palette',
  'Deux couleurs d’accent que les parties et les motifs peuvent réutiliser.':
    'Two accent colors that parts and markings can reuse.',
  Accent: 'Accent',
  'Accent 2': 'Accent 2',
  Autre: 'Custom',
  Aucune: 'None',
  Aucun: 'None',
  'Harmonies suggérées': 'Suggested harmonies',
  ...
  Pastel: 'Pastel',
  Braise: 'Ember',
  'Palette surprise': 'Surprise palette',
  'Ombrage cartoon': 'Cartoon shading',
  'Une ombre franche et un reflet qui suivent la silhouette, par-dessus n’importe quel rendu.':
    'A crisp shadow and highlight that follow the silhouette, on top of any rendering style.',
  Ombre: 'Shadow',
  Reflet: 'Shine',
  'Épaisseur de l’ombre': 'Shadow depth',
  'Direction de la lumière': 'Light direction',
  'Couleur de l’ombre': 'Shadow color',
  Motifs: 'Markings',
  'Taches, rayures, gemmes et zones bicolores qui épousent la forme principale en 3D.':
    'Spots, stripes, gems and two-tone areas that wrap around the primary shape in 3D.',
  'Ajouter un motif': 'Add a marking',
  'Tache du ventre': 'Belly patch',
  Museau: 'Muzzle',
  Masque: 'Mask',
  Joues: 'Cheeks',
  Gemme: 'Gem',
  ...
  Taches: 'Spots',
  Rayures: 'Stripes',
  'Dessus bicolore': 'Two-tone top',
  'Dessous bicolore': 'Two-tone bottom',
  Ovale: 'Oval',
  Losange: 'Diamond',
  'Carré doux': 'Soft square',
  Croissant: 'Crescent',
  Motif: 'Decal',
  Monter: 'Move up',
  Descendre: 'Move down',
  ...
  'Couleur de la partie': 'Part color',
  Pointe: 'Tip',
  'Longueur de la pointe': 'Tip length',
  Anneaux: 'Rings',
  'Nombre d’anneaux': 'Ring count',
  'Couleur de la forme': 'Shape color',
  'Intensité de l’ombre': 'Shade strength',
  'Taille de la lueur': 'Glow size',
  ...
  'Fond de la scène': 'Stage background',
  Scène: 'Stage',
  'Couleur derrière l’avatar sur la scène.': 'Color behind the avatar on the stage.',
  ...
  Pose: 'Pose',
  Parole: 'Speech',
  'Génère la voix, puis lance la phrase pour bouger la bouche.':
    'Generate the voice, then play the line to move the mouth.',
  'Azure Speech': 'Azure Speech',
  'La clé reste dans cette session et n’est pas enregistrée.':
    'The key stays in this session and is not saved.',
  'Clé Azure': 'Azure key',
  ...
  Excité: 'Excited',
  Chuchoté: 'Whisper',
  'Colle ta clé Azure Speech.': 'Paste your Azure Speech key.',
  'Indique la région, par exemple eastus.': 'Enter the region, for example eastus.',
  'Écris ce que l’avatar doit dire.': 'Write what the avatar should say.',
  'Génération…': 'Generating…',
  Prêt: 'Ready',
  'En train de parler': 'Talking',
  'La synthèse a échoué.': 'Speech generation failed.',
  ...
  'Ce fichier ne contient pas un projet little guys valide et compatible.':
    'This file does not contain a valid, compatible little guys project.',
  ...
  'Ajouter une partie': 'Add a part',
  'Points de forme': 'Shape points',
  'Glisse un point pour plier la partie. Glisse l’anneau pour changer l’épaisseur. Clique la partie pour ajouter un point.':
    'Drag a point to bend the part. Drag the ring to change thickness. Click the part to add a point.',
  Épaisseur: 'Thickness',
  'Ajouter un point': 'Add a point',
  'Retirer un point': 'Remove a point',
  'Queue courte': 'Short tail',
  'Queue longue': 'Long tail',
  'Queue épaisse': 'Thick tail',
  Queue: 'Tail',
  Oreille: 'Ear',
  Corne: 'Horn',
  Ventre: 'Belly',
...
const dynamicTranslations: [RegExp, string][] = [
  ...
  [/^Ajouter une partie · (.+)$/, 'Add a part · $1'],
